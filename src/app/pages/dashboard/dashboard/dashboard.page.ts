		...
		for (var i = 0; i < number; i++) {
			if (this.listarIncidencias[i + originalLengh] != undefined && this.listarIncidencias[i + originalLengh].finalizo != 1) {
				...
				el.innerHTML = '<ion-label>' +
					...
					`<p style="margin: 0px; display:flex; flex-direction: column;"><strong style="font-size: 11px;"><label style="color: black;"> Asunto:</label></strong><textarea disabled rows="2" class="listFecha" style="float: right;font-size: 11px;"> ${self.listarIncidencias[i + originalLengh].asunto}</textarea></p>` +
